...
public class Const {
	...
	public static final String LOGIN = "/index.jsp"; // 登录地址
	...
	public static final String NO_INTERCEPTOR_PATH = "\b|.*/((login)|(logout)|(weixin)|(assets)|(appweb)|(css)|(data)|(js)|(easyui)|(common)).*"; // 不对匹配该值的访问路径拦截（正则）
}
