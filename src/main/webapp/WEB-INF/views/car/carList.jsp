			...
			<div class="tabs-wrapper">
				<div class="comp-search-box">
					<div class="screen-top">
						<div class="colRow">
							<input id="txtNewPass" type="text" class="easyui-textbox" name="name" data-options="label:'车牌号'" />
						</div>
						<div class="colRow">
							<input id="numbers" type="text" class="easyui-textbox" name="name" data-options="label:'设备编号'" />
						</div>
						<div class="colRow">
							<input type="text" id="selest-item" name="" class="easyui-combobox" name="language" label="供应商名称" />
						</div>
						<div class="colRow">
...
// 				fit : true,
				...
				columns : [ [ {
					...
					formatter : function(value, row, index) {
						return '<a href="javascript:;" title="查看" class="green" onclick="lockInfo()"><i class="fa fa-eye"></i></a>';
					}
				}, {
					field : 'carNumber',
					title : '车牌号',
